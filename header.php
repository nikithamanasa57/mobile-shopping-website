...
//checks if a session has been started, if not it starts one  
if( ! $_SESSION)
{
    session_start();
} 
...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-light">
        ...
        <div class="font-rale font-size-14">
            ...
            <a href="#cart" class="px-3 border-right text-dark">Whishlist (0)</a>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
        ...
        <a class="navbar-brand" href="../shopee/shopee.php">Mobile Shopee</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav m-auto font-rubik">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#new-phones">Products </i></a>
                </li>
                <li class="nav-item">
